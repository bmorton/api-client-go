...
type ClientService interface {
	...
	PatchV1IntegrationsConfluenceCloudConnectionsID(params *PatchV1IntegrationsConfluenceCloudConnectionsIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PatchV1IntegrationsConfluenceCloudConnectionsIDOK, error)
...
/*
  PatchV1IntegrationsConfluenceCloudConnectionsID updates a confluence connection

  Update the given Confluence integration connection.
*/
func (a *Client) PatchV1IntegrationsConfluenceCloudConnectionsID(params *PatchV1IntegrationsConfluenceCloudConnectionsIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PatchV1IntegrationsConfluenceCloudConnectionsIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPatchV1IntegrationsConfluenceCloudConnectionsIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "patchV1IntegrationsConfluenceCloudConnectionsId",
		Method:             "PATCH",
		PathPattern:        "/v1/integrations/confluence_cloud/connections/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PatchV1IntegrationsConfluenceCloudConnectionsIDReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*PatchV1IntegrationsConfluenceCloudConnectionsIDOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for patchV1IntegrationsConfluenceCloudConnectionsId: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
