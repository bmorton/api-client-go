...
/*PostV1PostMortemsReportsReportIDPublishCreated handles this case with default header values.
...
/*PostV1PostMortemsReportsReportIDPublishBadRequest handles this case with default header values.
